...
/**
 * Generate Packing List HTML template
 */
function generatePLTemplate(data) {
    ...
    const containerTruckList = containers.map(c => c.container_no || '').join('<br/>');
...
<div class="page">
    ...
    <table class="product-table">
        ...
        <tr>
            ...
            <td>
                ${data.nett_weight || ''} X ${data.total_packages || ''}<br/>
                ${data.unit_1 || ''} &nbsp; ${data.unit_2 || ''}<br/>
...
module.exports = { generatePLTemplate };
